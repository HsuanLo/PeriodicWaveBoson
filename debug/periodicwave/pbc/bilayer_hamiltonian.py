...
def local_energy(
    ...
    potential_intra_scale: float = 1.0,
    potential_inter_scale: float = 1.0,
  ...
  def _e_l(
    ...
    potential_intra = potential_intra_scale * potential_parts["intra"]
    potential_inter = potential_inter_scale * potential_parts["inter"]
    potential_energy = potential_intra + potential_inter
    total_energy = kinetic_energy + potential_energy
    return total_energy, {
        "kinetic": kinetic_energy,
        "potential": potential_energy,
        "potential_intra": potential_intra,
        "potential_inter": potential_inter,
    }
